...
///////////////////////////////////////////////////////////////////////////////
/**
 * Changed September 2017 by Follpvosten to fit into my program.
 */
...
public class ElizaConfig {
     ...
     * replaced with "i am". These are called parallel arrays since their
     * elements correspond.
     */
    ...
    /**
     * Before user input is utilized in a response, it is scanned for the items
     ...
     * set is composed of a pattern and a list of responses. { {{ patternA1 }, {
     * responseA1, responseA2, responseA3}}, {{ patternB1 }, { responseB1,
     * responseB2, responseB3}} }
     *
    ...
    /**
     * Used to seed the java.util.Random object for generating random numbers.
     * By seeding the Random generator, we can predict the "pseudo-random"
     * values that will be generated. This predictability aids in program
     * development and allows for automated grading. Update 2/17
     */
    static final int SEED = 123;

    /**
     * Use the RNG named constant in your methods that require randomly choosing
     * a response. In this project only one method, chooseString, requires the
